!function (t) {
  ...
  void 0 === t.btoa && (t.btoa = (h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split(""),
    function (r) {
      var e, t, n, o, a, c, i;
      for (t = n = 0, o = r.length, c = (o -= a = o % 3) / 3 << 2, 0 < a && (c += 4), e = new Array(c); t < o;) i = r.charCodeAt(t++) << 16 | r.charCodeAt(t++) << 8 | r.charCodeAt(t++),
        e[n++] = h[i >> 18] + h[i >> 12 & 63] + h[i >> 6 & 63] + h[63 & i];
      return 1 == a ? (i = r.charCodeAt(t++), e[n++] = h[i >> 2] + h[(3 & i) << 4] + "==") : 2 == a && (i = r.charCodeAt(t++) << 8 | r.charCodeAt(t++), e[n++] = h[i >> 10] + h[i >> 4 & 63] + h[(15 & i) << 2] + "="),
        e.join("")
    })),
  ...
  function i(r, e) {
    return (null == e || e < 0) && (e = r.length),
      0 === e ? "" : b(r) || !p(r) ? e === r.length ? r : r.substr(0, e) : (e < 32767 ?
        function (r, e) {
          ...
          return 0 < o && (n.length = o, t[t.length] = String.fromCharCode.apply(String, n)),
            t.join("")
        })(r, e)
  }
  function f(r, e) {
    return null == r || 0 === r.length ? r : (r = c(r), e = c(e), n(function (r, e) {
      ...
      for (n = r[f], i = (o = 0) | Math.floor(6 + 52 / h); 0 < i; --i) {
        for (a = (o = s(o + d)) >>> 2 & 3, c = 0; c < f; ++c) t = r[c + 1],
...
const XXTEA = (this || [eval][0]("this")).XXTEA;
